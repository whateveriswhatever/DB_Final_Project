CREATE TABLE Customer_Products (
    Transaction_ID UNIQUEIDENTIFIER NOT NULL UNIQUE DEFAULT NEWID(),
...
VALUES
    ...
    (890126, 3, 'Thai Binh', 3, '2014-01-22 09:45:00', 'Credit Card', 0),
    (918160, 4, 'Ba Dinh district, Hanoi', 1, '2024-06-10 16:10:00', 'Debit Card', 1),
    (156192, 5, 'unknown', 4, '2010-02-28 11:00:00', 'Cash', 1),
    (212517, 2, '456 Le Loi street, Hai Ba Trung district, Hanoi', 2, '2024-04-18 13:40:00', 'Credit Card', 0),
    ...
    (485324, 11, '456 Le Loi street, Hai Ba Trung district, Hanoi', 2, '2023-08-22 14:30:00', 'Credit Card', 0),
    ...
    (412892, 15, 'Hoan Kiem district, Hanoi', 3, '2024-12-01 13:10:00', 'Cash', 0),
    (602475, 16, '99 Le Loi street, Hai Ba Trung district, Hanoi', 2, '2024-12-05 15:00:00', 'Credit Card', 0),
